...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.MonitoriaRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CursoRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.MonitorRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.MaterialRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.DisciplinaRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.CurtidaRepository.fragments#0'.
     */

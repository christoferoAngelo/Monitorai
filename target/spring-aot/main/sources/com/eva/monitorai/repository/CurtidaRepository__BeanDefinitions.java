...
/**
 * Bean definitions for {@link CurtidaRepository}.
 */
@Generated
public class CurtidaRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'curtidaRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getCurtidaRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'curtidaRepository'.
   */
  public static BeanDefinition getCurtidaRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, CurtidaRepository.class, Curtida.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.eva.monitorai.repository.CurtidaRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.CurtidaRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.eva.monitorai.repository.CurtidaRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getCurtidaRepositoryInstanceSupplier();

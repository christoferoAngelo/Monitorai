...
/**
 * Bean definitions for {@link CursoRepository}.
 */
@Generated
public class CursoRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'cursoRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getCursoRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'cursoRepository'.
   */
  public static BeanDefinition getCursoRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, CursoRepository.class, Curso.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.eva.monitorai.repository.CursoRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.CursoRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.eva.monitorai.repository.CursoRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getCursoRepositoryInstanceSupplier();

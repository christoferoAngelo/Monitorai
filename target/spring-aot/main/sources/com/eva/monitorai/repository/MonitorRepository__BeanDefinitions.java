...
/**
 * Bean definitions for {@link MonitorRepository}.
 */
@Generated
public class MonitorRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'monitorRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getMonitorRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'monitorRepository'.
   */
  public static BeanDefinition getMonitorRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, MonitorRepository.class, Monitor.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.eva.monitorai.repository.MonitorRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.MonitorRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.eva.monitorai.repository.MonitorRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getMonitorRepositoryInstanceSupplier();

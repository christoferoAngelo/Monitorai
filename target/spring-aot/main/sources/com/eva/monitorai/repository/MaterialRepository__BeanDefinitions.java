...
/**
 * Bean definitions for {@link MaterialRepository}.
 */
@Generated
public class MaterialRepository__BeanDefinitions {
  /**
   * Get the bean instance supplier for 'materialRepository'.
   */
  private static BeanInstanceSupplier<JpaRepositoryFactoryBean> getMaterialRepositoryInstanceSupplier(
      ) {
  ...
  /**
   * Get the bean definition for 'materialRepository'.
   */
  public static BeanDefinition getMaterialRepositoryBeanDefinition() {
    RootBeanDefinition beanDefinition = new RootBeanDefinition(JpaRepositoryFactoryBean.class);
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, MaterialRepository.class, Material.class, Long.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.eva.monitorai.repository.MaterialRepository");
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragments", new RuntimeBeanReference("jpa.MaterialRepository.fragments#0"));
    ...
    beanDefinition.getPropertyValues().addPropertyValue("repositoryFragmentsFunction", new RepositoryFactoryBeanSupport.RepositoryFragmentsFunction() {
      public RepositoryComposition.RepositoryFragments getRepositoryFragments(
        ...
        return RepositoryComposition.RepositoryFragments.just(new com.eva.monitorai.repository.MaterialRepositoryImpl__AotRepository(entityManager, context));
      }
    });
    InstanceSupplier<JpaRepositoryFactoryBean> instanceSupplier = getMaterialRepositoryInstanceSupplier();

 ...
 */
@Generated
public class MonitoraiApplication__ApplicationContextInitializer implements ApplicationContextInitializer<GenericApplicationContext> {
  @Override
  public void initialize(GenericApplicationContext applicationContext) {
    ...
    new MonitoraiApplication__BeanFactoryRegistrations().registerBeanDefinitions(beanFactory);
    new MonitoraiApplication__BeanFactoryRegistrations().registerAliases(beanFactory);
  }
  ...
  private void addImportAwareBeanPostProcessors(DefaultListableBeanFactory beanFactory) {
    ...
    mappings.put("org.springframework.security.config.annotation.method.configuration.PrePostMethodSecurityConfiguration", "com.eva.monitorai.config.SecurityConfig");
